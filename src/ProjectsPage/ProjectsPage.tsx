...
const ProjectsPage = () => {
  ...
  return (
    <section className="text-center my-1 mt-4">
      ...
      <p className="grey-text w-responsive mx-auto mb-5">Seattle based Software Development Engineer. Frenchie Dad. Car Enthusiast.</p>
          ...
          >
            <div className="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4 rounded">
              <div>
                ...
                <p className="pb-3">
                  Multi-service web-app that Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laborum quidem molestias recusandae harum sunt impedit dolor est. Officia dicta ea eaque ab neque libero aliquid! Nihil illo dignissimos
                  eveniet voluptate.
                </p>
                  <MDBBtn gradient="purple" rounded href="https://github.com/DevinTyler26/myTesla" target="_blank" disabled>
          ...
          >
            <div className="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4 rounded">
              <div>
                ...
                <MDBBtn gradient="aqua" rounded disabled>
